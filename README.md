...
|---------|-----|-------------|
| **🎤 VICTOR-TTS Web** | http://localhost:7000 | **Enhanced Web Interface (หลัก)** |
...
### 🚀 คู่มือเริ่มต้น
- **[QUICK_START_GUIDE.md](QUICK_START_GUIDE.md)** - คู่มือเริ่มต้นใช้งานแบบย่อ
- **[USER_GUIDE.md](USER_GUIDE.md)** - คู่มือการใช้งานแบบละเอียด

### 🎯 ฟีเจอร์หลัก
- **🌍 Multi-language Support**: ไทย, ลาว, อังกฤษ, จีน, ญี่ปุ่น
- **🎭 RVC Voice Conversion**: แปลงเสียงด้วย AI
- **🎨 Special Effects**: เอฟเฟกต์พิเศษ (ปีศาจ, หุ่นยนต์, เสียงสะท้อน)
...
- **[🚀 QUICK_START_GUIDE.md](QUICK_START_GUIDE.md)** - คู่มือเริ่มต้นใช้งานแบบย่อ
- **[📖 USER_GUIDE.md](USER_GUIDE.md)** - คู่มือการใช้งานแบบละเอียด
- **[🌐 WEB_INTERFACE_GUIDE.md](WEB_INTERFACE_GUIDE.md)** - คู่มือเว็บอินเทอร์เฟซ
...
**VICTOR-TTS** เป็นระบบ Text-to-Speech แบบครบวงจรที่รวมเทคโนโลยีล่าสุดเข้าด้วยกัน:

### ✨ ฟีเจอร์เด่น
- 🎤 **TTS คุณภาพสูง** จาก Microsoft Edge TTS
- 🎭 **RVC Voice Conversion** สำหรับแปลงเสียง
- 🌍 **Multi-language Support** รองรับ 5 ภาษา
- 🎨 **Special Effects** เอฟเฟกต์พิเศษหลากหลาย
- ⚡ **Performance Optimized** รองรับ GPU acceleration
- 🎵 **Multilingual Mode** สำหรับภาษาลาว
...
### 📖 คู่มือแนะนำ
- **[QUICK_START_GUIDE.md](QUICK_START_GUIDE.md)** - เริ่มต้นใช้งานใน 5 นาที
- **[USER_GUIDE.md](USER_GUIDE.md)** - คู่มือการใช้งานแบบละเอียด

@echo off
title VICTOR-TTS GITHUB FIXED VERSION

echo.
echo ========================================
echo VICTOR-TTS GITHUB FIXED VERSION
echo ========================================
echo GitHub version with fixes
echo ========================================
echo.
...
echo.
echo ========================================
echo STARTING VICTOR-TTS FIXED SERVER
echo ========================================
...
:: เริ่มต้นเซิร์ฟเวอร์
python main_api_server_fixed.py --host 0.0.0.0 --port 6969
